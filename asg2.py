...
class Win(QMainWindow):
    ...
    #
    #     img_pen = QImage(self.image, self.image.shape[1], self.image.shape[0], self.image.shape[1] * 3,
    #                       QImage.Format_RGB888).rgbSwapped()
    #     self.pixmap = QPixmap(img_pen)
    #     self.keepRatio()
    #     self.label.setPixmap(self.pixmap)
    ...
    def showMerge(self):
        ...
        img_merge = QImage(self.image, self.image.shape[1], self.image.shape[0], self.image.shape[1] * 3,
                           QImage.Format_RGB888).rgbSwapped()
        self.pixmap = QPixmap(img_merge)
        self.keepRatio()
        self.label.setPixmap(self.pixmap)
    ...
    def grayHistEqua(self):
        ...
        aft_image = QImage(self.image, self.image.shape[1], self.image.shape[0], self.image.shape[1],
                           QImage.Format_Grayscale8)
        self.pixmap = QPixmap(aft_image)
        self.keepRatio()
        self.label.setPixmap(self.pixmap)
    ...
    def colorHistEqua(self):
        ...
        self.image = self.img_aft
        aft_image = QImage(self.image, self.image.shape[1], self.image.shape[0], self.image.shape[1]*3,
                           QImage.Format_RGB888).rgbSwapped()
        self.pixmap = QPixmap(aft_image)
        self.keepRatio()
        self.label.setPixmap(self.pixmap)
    ...
    def closeBlur(self):
        ...
        img_blur = QImage(self.image, self.image.shape[1], self.image.shape[0], self.image.shape[1] * 3,
                               QImage.Format_RGB888).rgbSwapped()
        self.pixmap=QPixmap(img_blur)
        self.keepRatio()
        self.label.setPixmap(self.pixmap)
    ...
    def displayContrast(self):
        ...
        contrast_img = QImage(self.image, self.image.shape[1], self.image.shape[0],self.image.shape[1] * 3,
                              QImage.Format_RGB888).rgbSwapped()
        self.pixmap=QPixmap(contrast_img)
        self.keepRatio()
        self.label.setPixmap(self.pixmap)
    ...
    def sharpDialog(self):
        ...
        pixmap_1 = QPixmap(sharpened5_img)
        pixmap_1 = pixmap_1.scaled(200, 300, QtCore.Qt.KeepAspectRatio)
        self.sDlg.label_5.setPixmap(pixmap_1)
    ...
    def closeSharp(self):
        ...
        sharpened_img = QImage(self.image, self.image.shape[1], self.image.shape[0], self.image.shape[1] * 3,
                              QImage.Format_RGB888).rgbSwapped()
        self.pixmap = QPixmap(sharpened_img)
        self.keepRatio()
        self.label.setPixmap(self.pixmap)
